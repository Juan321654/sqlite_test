...
connection = sqlite3.connect('gta.db')  # connect to database
cursor = connection.cursor()  # this is the object that will do the queries
...
print("*********************")
for i in gta_search:
    adjusted = [cities_search[0][1] if value ==
